...
class InvestigadoresControllerEdgeCasesTest {
    ...
    void setup() throws Exception {
        temp = Files.createTempFile("invest_ctrl_edge", ".csv");
    }
    ...
    @Test
    void listarSinInvestigadoresNoFalla() {
