...
class ActoresControllerEdgeCasesTest {
    ...
    void setup() throws Exception {
        temp = Files.createTempFile("actores_ctrl_edge", ".csv");
    }
    ...
    @Test
    void opcionInvalida() {
        StubView stub = new StubView(List.of(999, 3));
        ActoresController controller = new ActoresController(stub, temp.toString());
        controller.iniciar();
